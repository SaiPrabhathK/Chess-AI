...
{
    public:
        static std::string timeLimitedIterativeDeepeningABMInMax(std::string orgFenString, double remainingTime); //time limited iterative deepening alpha beta minimax function.
