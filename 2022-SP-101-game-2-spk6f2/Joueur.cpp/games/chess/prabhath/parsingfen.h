...
{
    public:
        static std::string  iterativeDeepening(std::string fenString);
        static int  maxPlayer(GameBoard eachMinPlayerGameState, int depth);
        static int  minPlayer(GameBoard eachMaxPlayerGameState, int depth);
        static Move maxChoice(GameBoard &initGameBoard, int depth);
};
